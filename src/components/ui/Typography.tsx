...
export function LargeText({ className, children, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return (
...
export function SmallText({ className, children, ...props }: React.HTMLAttributes<HTMLElement>) {
  return (
