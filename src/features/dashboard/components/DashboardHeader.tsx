      ...
      <header className="h-16 border-b border-border bg-card flex items-center justify-between px-4 md:px-6 sticky top-0 z-30">
        ...
        <div className="hidden md:flex items-center flex-1 max-w-md">
          <div className="relative w-full">
            ...
            <input 
              ...
              className="w-full pl-9 pr-4 py-2 bg-muted/50 border-transparent hover:bg-muted focus:bg-background focus:border-primary focus:ring-1 focus:ring-primary rounded-full text-sm transition-all outline-none h-10"
            />
          </div>
        </div>
        ...
        <div className="flex items-center gap-2 md:gap-4 ml-auto">
          ...
          <button 
            ...
            className="p-2 text-muted-foreground hover:text-foreground hover:bg-muted rounded-full transition-colors md:hidden min-h-[44px] min-w-[44px] flex items-center justify-center"
